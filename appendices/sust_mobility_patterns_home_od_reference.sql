...
INSERT INTO analysis.mobility_patterns_stats (measure) SELECT 'home od randstad';

--SELECT _phd_updatecolumns('analysis','mobility_patterns', 5, 87, '0 WHERE pattern.measure=''home od randstad''',NULL,NULL);
--SELECT _phd_updatecolumns('analysis','mobility_patterns', 5, 87, '0 WHERE ',NULL,' IS NULL AND pattern.measure=''home od randstad''');
...
FROM (SELECT count(*) total FROM survey.randstad_journeys
WHERE mm_code <> 3 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET legs=temp.total
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET persons=temp.total
FROM (SELECT count(*) total FROM 
(SELECT persid FROM survey.randstad_journeys GROUP BY persid) AS aa) AS temp WHERE
pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET distance=temp.total
FROM (SELECT sum(afstv)/10.0 total FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET duration=temp.total
FROM (SELECT sum(rsdduur) total FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET distance_legs=temp.total
FROM (SELECT sum(afstr)/10.0 total FROM survey.randstad_journeys WHERE agg_pcode=home_pcode) AS temp 
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET duration_legs=temp.total
FROM (SELECT sum(rrsdduur) total FROM survey.randstad_journeys WHERE agg_pcode=home_pcode) AS temp 
WHERE pattern.measure='home od randstad';
...
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE (mode_leg='1' OR mode_leg='12') AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET cycle=round(((temp.total/legs::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE mode_leg='2' AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET car=round(((temp.total/legs::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE (mode_leg='3' OR mode_leg='4') AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET bus=round(((temp.total/legs::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE mode_leg='5' AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET tram=round(((temp.total/legs::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE mode_leg='6' AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET train=round(((temp.total/legs::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE mode_leg='7' AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET non_car=round(((temp.total/legs::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE mode_leg<>'3' AND mode_leg<>'4' AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET motorised=round(((temp.total/legs::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE mode_leg NOT IN ('1','2','12') AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET transit=round(((temp.total/legs::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE mode_leg IN ('5','6','7','8','11') AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';
...
FROM (SELECT count(*) total FROM survey.randstad_journeys WHERE mm_code IN (1,2,4,5) AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';

-- distance restricted mode indicators
UPDATE analysis.mobility_patterns_stats AS pattern SET short=temp.total
FROM (SELECT count(*) total FROM survey.randstad_journeys 
WHERE afstr<=15 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET medium=temp.total
FROM (SELECT count(*) total FROM survey.randstad_journeys 
WHERE afstr>15 AND afstr<100 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET far=temp.total
FROM (SELECT count(*) total FROM survey.randstad_journeys 
WHERE afstr>=100 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';
...
FROM (SELECT sum(afstr)/10.0 total FROM survey.randstad_journeys WHERE
...
FROM (SELECT sum(rrsdduur) total FROM survey.randstad_journeys WHERE
mode_leg IN ('5','6','7','8','11') AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';
...
FROM (SELECT count(*) total FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND vertpc=aankpc AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET urban=round(((temp.total/journeys::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND vertgem=aankgem AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';
...
FROM (SELECT count(*) total FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND afstv<=15 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET medium=round(((temp.total/journeys::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND afstv>15 AND afstv<100 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';

UPDATE analysis.mobility_patterns_stats AS pattern SET far=round(((temp.total/journeys::double precision)*100)::numeric,2)
FROM (SELECT count(*) total FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND afstv>=100 AND agg_pcode=home_pcode) AS temp WHERE pattern.measure='home od randstad';
...
FROM (SELECT sum(afstv)/10.0 total, count(*) journeys FROM survey.randstad_journeys 
...
FROM (SELECT sum(rsdduur) total, count(*) journeys FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND (kmotief='1' AND aankbzh<>'1') AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';
...
FROM (SELECT median(afstv)/10.0 median FROM survey.randstad_journeys 
...
FROM (SELECT median(rsdduur) median FROM survey.randstad_journeys 
WHERE mm_code <> 3 AND agg_pcode=home_pcode) AS temp
WHERE pattern.measure='home od randstad';
